...
"""autogenerated by genpy from locobot_simulation/ObjectInfos.msg. Do not edit."""
import codecs
import sys
...
class ObjectInfos(genpy.Message):
  _md5sum = "1324374ccaec257e2f70fe89faafdce9"
  _type = "locobot_simulation/ObjectInfos"
...
"""
  ...
  _slot_types = ['std_msgs/Header','locobot_simulation/ObjectInfo[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = locobot_simulation.msg.ObjectInfo()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
